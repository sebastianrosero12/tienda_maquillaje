            ...
            <div class="carousel-inner">
                  ...
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="row">
                           <div class="col-md-6">
                              <div class="text-bg">
                                 <span>Productos Infaltables</span>
                                 <h1>Accessories</h1>
                           ...
                           <div class="col-md-6">
                              <div class="text_img">
                                 <figure><img src="{{asset('images/banner1.png')}}" alt="#"/></figure>
                              </div>
                           </div>
                        </div>
                     </div>
               ...
               <div class="carousel-item">
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="text_img">
                                 <figure><img src="{{asset('images/banner3.png')}}" alt="#"/></figure>
                              </div>
                     </div>
                  </div>
               </div>
